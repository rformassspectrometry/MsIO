...
**Compiled**: Fri Apr 17 13:44:49 2026
...
```
    ...
    ## 5f0b3899848f_7861 Pestmix1 D...         DDA /github/ho...
    ## 5f0b37894d7a_7862 Pestmix SW...       SWATH /github/ho...
...
```
    ...
    ##   [7] MsBackendMetaboLights_1.5.3 matrixStats_1.5.0          
    ...
    ##  [61] KEGGREST_1.51.1             evaluate_1.0.5             
    ...
    ##  [75] alabaster.base_1.11.4       glue_1.8.1                 
    ##  [77] alabaster.matrix_1.7.8      lazyeval_0.2.3             
    ##  [79] tools_4.7.0                 AnnotationHub_4.1.0        
    ##  [81] data.table_1.18.2.1         mzR_2.45.1                 
    ##  [83] QFeatures_1.21.2            fs_2.0.1                   
    ##  [85] rhdf5_2.55.16               grid_4.7.0                 
    ##  [87] tidyr_1.3.2                 MsCoreUtils_1.23.9         
    ##  [89] AnnotationDbi_1.73.1        HDF5Array_1.39.1           
