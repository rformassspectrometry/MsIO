...
vignette: >
    ...
    %\VignetteDepends{MsIO,BiocStyle,MsDataHub,MsExperiment,Spectra}
---
...
*MsIO* currently does not support serializing *in-memory* MS data, such as
`Spectra` objects using `MsBackendDataFrame` or `MsBackendMemory`.
